...
# Prior to using this script, ensure SNP data is in PLINK .ped/.map format. Remove all duplicates, and keep *only* triploids of interest (e.g. unidentified triploid samples).
# Triploids are being treated as diploids in this script, as per Muranty et al. 2020.
...
write.table(genome, "C:/Users/curly/Desktop/Apple Genotyping/Results/Parent Pedigree Analysis/Triploid Results/Trip_IBD.txt", sep = "\t", row.names = FALSE, quote = FALSE)
...
SNPdata.filepath <- "C:/Users/curly/Desktop/Apple Genotyping/Methods/Parent Pedigree Analysis/Inputs/Trip"
SNPdata.rootfilename <- "Trip_Data"
...
filename.trio.output <- "C:/Users/curly/Desktop/Apple Genotyping/Results/Parent Pedigree Analysis/Triploid Results/trios.txt"
filename.duo.output <- "C:/Users/curly/Desktop/Apple Genotyping/Results/Parent Pedigree Analysis/Triploid Results/duos.txt"
...
png(filename = "C:/Users/curly/Desktop/Apple Genotyping/Results/Parent Pedigree Analysis/Triploid Results/ME_plot.png", width = 600, height = 600)
